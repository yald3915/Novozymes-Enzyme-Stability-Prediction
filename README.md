This file is the baseline code for Novozymes Enzyme Stability Prediction--Help identify the thermostable mutations in enzymes

以上文件是Novozymes Enzyme Stability Prediction--Help identify the thermostable mutations in enzymes（酶稳定性预测）比赛的baseline代码
